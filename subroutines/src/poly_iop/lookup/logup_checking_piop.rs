    ...
    Instruction: JoltInstruction + Default,
{
    ...
    > {
        ...
        let g_proof = <Self as RationalSumcheckSlow<E>>::prove(
            &g_leaves.0,
            &g_leaves.1,
            &g_leaves.2,
            claimed_sums,
    ...
    > {
        ...
        if Net::am_master() {
            ...
            let f_proof_ret = <Self as RationalSumcheckSlow<E>>::d_prove(
                &f_p,
                &f_q,
                &f_q_inv,
                claimed_sums.clone(),
            ...
            let g_proof_ret = <Self as RationalSumcheckSlow<E>>::d_prove(
                &g_leaves.0,
                &g_leaves.1,
                &g_leaves.2,
                claimed_sums,
            ...
            <Self as RationalSumcheckSlow<E>>::d_prove(
                &f_p,
                &f_q,
                &f_q_inv,
                claimed_sums.clone(),
            ...
            Ok((None, f_advice, f_leaves.2, g_leaves.2))
        }
    }
    ...
    fn verify_logup_checking(
        ...
        rayon::join(
            ...
            || {
                ...
                let f_subclaims = <Self as RationalSumcheckSlow<E>>::verify(
                    &proof.f_proof,
                    aux_info_f,
                    transcript,
                )?;

                let g_subclaims = <Self as RationalSumcheckSlow<E>>::verify(
                    &proof.g_proof,
                    aux_info_g,
                    transcript,
                )?;
