...
use crate::{base::pairings, DeferredG1, DeferredG2, DeferredGT, VerifierSetup};
...
pub fn verify_de_eval_proof<E: Pairing>(
    ...
    let mut sub_R_vec = vec![f_zero; sub_mat_len];
    let mut sub_L_vec = vec![f_zero; sub_mat_len];
    ...
    let mut suffix_vec = vec![f_zero; 1usize << m];
